...
#### Security Tools
- [Hubert Seiwert's Remote Host Key Scanner](Archives/Remote-host-key-scanner-for-Debian-SSH-updated-2008-05-16.md)
- Sebastian Spitzner's Remote Host Key Scanner (v1)
- [Markus Mueller's Brute Force Perl Script](Archives/Markus-Mueller's-Brute-Force-Perl-Script.txt)
- L4teral's Brute Force Ruby Script
- [CR0.org's Debian SSH/SSL Tools](https://www.cr0.org/progs/sshfun/)
- [Bootable SSL Certificate Generator (ISO)](Archives/sslbreak.iso)
...
Pay tribute to HD Moore and thanks g0tmi1k. [Original](http://metasploit.com/users/hdm/tools/debian-openssl/)(unlinked) ([Mirror](http://web.archive.org/web/20110723091928/http://digitaloffense.net/tools/debian-openssl/))
